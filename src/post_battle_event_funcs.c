...
int GameClear(void)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_NUVEMA_TOWN_BRENDANS_HOUSE_2F);
    else
        SetContinueGameWarpToHealLocation(HEAL_LOCATION_NUVEMA_TOWN_MAYS_HOUSE_2F);
