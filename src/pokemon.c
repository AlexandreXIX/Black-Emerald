...
#define UNOVA_TO_NATIONAL(name)     [UNOVA_DEX_##name - 1] = NATIONAL_DEX_##name

// Assigns all Unova Dex Indexes to a National Dex Index
static const u16 sUnovaToNationalOrder[UNOVA_DEX_COUNT - 1] =
{
    UNOVA_TO_NATIONAL(SNIVY),
    UNOVA_TO_NATIONAL(SERVINE),
    UNOVA_TO_NATIONAL(SERPERIOR),
    UNOVA_TO_NATIONAL(TEPIG),
    UNOVA_TO_NATIONAL(PIGNITE),
    UNOVA_TO_NATIONAL(EMBOAR),
    UNOVA_TO_NATIONAL(OSHAWOTT),
    UNOVA_TO_NATIONAL(DEWOTT),
    UNOVA_TO_NATIONAL(SAMUROTT),
    UNOVA_TO_NATIONAL(PATRAT),
    UNOVA_TO_NATIONAL(WATCHOG),
    UNOVA_TO_NATIONAL(LILLIPUP),
    UNOVA_TO_NATIONAL(HERDIER),
    UNOVA_TO_NATIONAL(STOUTLAND),
    UNOVA_TO_NATIONAL(PURRLOIN),
    UNOVA_TO_NATIONAL(LIEPARD),
    UNOVA_TO_NATIONAL(PANSAGE),
    UNOVA_TO_NATIONAL(SIMISAGE),
    UNOVA_TO_NATIONAL(PANSEAR),
    UNOVA_TO_NATIONAL(SIMISEAR),
    UNOVA_TO_NATIONAL(PANPOUR),
    UNOVA_TO_NATIONAL(SIMIPOUR),
    UNOVA_TO_NATIONAL(MUNNA),
    UNOVA_TO_NATIONAL(MUSHARNA),
    UNOVA_TO_NATIONAL(PIDOVE),
    UNOVA_TO_NATIONAL(TRANQUILL),
    UNOVA_TO_NATIONAL(UNFEZANT),
    UNOVA_TO_NATIONAL(BLITZLE),
    UNOVA_TO_NATIONAL(ZEBSTRIKA),
    UNOVA_TO_NATIONAL(ROGGENROLA),
    UNOVA_TO_NATIONAL(BOLDORE),
    UNOVA_TO_NATIONAL(GIGALITH),
    UNOVA_TO_NATIONAL(WOOBAT),
    UNOVA_TO_NATIONAL(SWOOBAT),
    UNOVA_TO_NATIONAL(DRILBUR),
    UNOVA_TO_NATIONAL(EXCADRILL),
    UNOVA_TO_NATIONAL(AUDINO),
    UNOVA_TO_NATIONAL(TIMBURR),
    UNOVA_TO_NATIONAL(GURDURR),
    UNOVA_TO_NATIONAL(CONKELDURR),
    UNOVA_TO_NATIONAL(TYMPOLE),
    UNOVA_TO_NATIONAL(PALPITOAD),
    UNOVA_TO_NATIONAL(SEISMITOAD),
    UNOVA_TO_NATIONAL(THROH),
    UNOVA_TO_NATIONAL(SAWK),
    UNOVA_TO_NATIONAL(SEWADDLE),
    UNOVA_TO_NATIONAL(SWADLOON),
    UNOVA_TO_NATIONAL(LEAVANNY),
    UNOVA_TO_NATIONAL(VENIPEDE),
    UNOVA_TO_NATIONAL(WHIRLIPEDE),
    UNOVA_TO_NATIONAL(SCOLIPEDE),
    UNOVA_TO_NATIONAL(COTTONEE),
    UNOVA_TO_NATIONAL(WHIMSICOTT),
    UNOVA_TO_NATIONAL(PETILIL),
    UNOVA_TO_NATIONAL(LILLIGANT),
    UNOVA_TO_NATIONAL(BASCULIN),
    UNOVA_TO_NATIONAL(SANDILE),
    UNOVA_TO_NATIONAL(KROKOROK),
    UNOVA_TO_NATIONAL(KROOKODILE),
    UNOVA_TO_NATIONAL(DARUMAKA),
    UNOVA_TO_NATIONAL(DARMANITAN),
    UNOVA_TO_NATIONAL(MARACTUS),
    UNOVA_TO_NATIONAL(DWEBBLE),
    UNOVA_TO_NATIONAL(CRUSTLE),
    UNOVA_TO_NATIONAL(SCRAGGY),
    UNOVA_TO_NATIONAL(SCRAFTY),
    UNOVA_TO_NATIONAL(SIGILYPH),
    UNOVA_TO_NATIONAL(YAMASK),
    UNOVA_TO_NATIONAL(COFAGRIGUS),
    UNOVA_TO_NATIONAL(TIRTOUGA),
    UNOVA_TO_NATIONAL(CARRACOSTA),
    UNOVA_TO_NATIONAL(ARCHEN),
    UNOVA_TO_NATIONAL(ARCHEOPS),
    UNOVA_TO_NATIONAL(TRUBBISH),
    UNOVA_TO_NATIONAL(GARBODOR),
    UNOVA_TO_NATIONAL(ZORUA),
    UNOVA_TO_NATIONAL(ZOROARK),
    UNOVA_TO_NATIONAL(MINCCINO),
    UNOVA_TO_NATIONAL(CINCCINO),
    UNOVA_TO_NATIONAL(GOTHITA),
    UNOVA_TO_NATIONAL(GOTHORITA),
    UNOVA_TO_NATIONAL(GOTHITELLE),
    UNOVA_TO_NATIONAL(SOLOSIS),
    UNOVA_TO_NATIONAL(DUOSION),
    UNOVA_TO_NATIONAL(REUNICLUS),
    UNOVA_TO_NATIONAL(DUCKLETT),
    UNOVA_TO_NATIONAL(SWANNA),
    UNOVA_TO_NATIONAL(VANILLITE),
    UNOVA_TO_NATIONAL(VANILLISH),
    UNOVA_TO_NATIONAL(VANILLUXE),
    UNOVA_TO_NATIONAL(DEERLING),
    UNOVA_TO_NATIONAL(SAWSBUCK),
    UNOVA_TO_NATIONAL(EMOLGA),
    UNOVA_TO_NATIONAL(KARRABLAST),
    UNOVA_TO_NATIONAL(ESCAVALIER),
    UNOVA_TO_NATIONAL(FOONGUS),
    UNOVA_TO_NATIONAL(AMOONGUSS),
    UNOVA_TO_NATIONAL(FRILLISH),
    UNOVA_TO_NATIONAL(JELLICENT),
    UNOVA_TO_NATIONAL(ALOMOMOLA),
    UNOVA_TO_NATIONAL(JOLTIK),
    UNOVA_TO_NATIONAL(GALVANTULA),
    UNOVA_TO_NATIONAL(FERROSEED),
    UNOVA_TO_NATIONAL(FERROTHORN),
    UNOVA_TO_NATIONAL(KLINK),
    UNOVA_TO_NATIONAL(KLANG),
    UNOVA_TO_NATIONAL(KLINKLANG),
    UNOVA_TO_NATIONAL(TYNAMO),
    UNOVA_TO_NATIONAL(EELEKTRIK),
    UNOVA_TO_NATIONAL(EELEKTROSS),
    UNOVA_TO_NATIONAL(ELGYEM),
    UNOVA_TO_NATIONAL(BEHEEYEM),
    UNOVA_TO_NATIONAL(LITWICK),
    UNOVA_TO_NATIONAL(LAMPENT),
    UNOVA_TO_NATIONAL(CHANDELURE),
    UNOVA_TO_NATIONAL(AXEW),
    UNOVA_TO_NATIONAL(FRAXURE),
    UNOVA_TO_NATIONAL(HAXORUS),
    UNOVA_TO_NATIONAL(CUBCHOO),
    UNOVA_TO_NATIONAL(BEARTIC),
    UNOVA_TO_NATIONAL(CRYOGONAL),
    UNOVA_TO_NATIONAL(SHELMET),
    UNOVA_TO_NATIONAL(ACCELGOR),
    UNOVA_TO_NATIONAL(STUNFISK),
    UNOVA_TO_NATIONAL(MIENFOO),
    UNOVA_TO_NATIONAL(MIENSHAO),
    UNOVA_TO_NATIONAL(DRUDDIGON),
    UNOVA_TO_NATIONAL(GOLETT),
    UNOVA_TO_NATIONAL(GOLURK),
    UNOVA_TO_NATIONAL(PAWNIARD),
    UNOVA_TO_NATIONAL(BISHARP),
    UNOVA_TO_NATIONAL(BOUFFALANT),
    UNOVA_TO_NATIONAL(RUFFLET),
    UNOVA_TO_NATIONAL(BRAVIARY),
    UNOVA_TO_NATIONAL(VULLABY),
    UNOVA_TO_NATIONAL(MANDIBUZZ),
    UNOVA_TO_NATIONAL(HEATMOR),
    UNOVA_TO_NATIONAL(DURANT),
    UNOVA_TO_NATIONAL(DEINO),
    UNOVA_TO_NATIONAL(ZWEILOUS),
    UNOVA_TO_NATIONAL(HYDREIGON),
    UNOVA_TO_NATIONAL(LARVESTA),
    UNOVA_TO_NATIONAL(VOLCARONA),
    UNOVA_TO_NATIONAL(COBALION),
    UNOVA_TO_NATIONAL(TERRAKION),
    UNOVA_TO_NATIONAL(VIRIZION),
    UNOVA_TO_NATIONAL(TORNADUS),
    UNOVA_TO_NATIONAL(THUNDURUS),
    UNOVA_TO_NATIONAL(RESHIRAM),
    UNOVA_TO_NATIONAL(ZEKROM),
    UNOVA_TO_NATIONAL(LANDORUS),
    UNOVA_TO_NATIONAL(KYUREM),
    UNOVA_TO_NATIONAL(KELDEO),
    UNOVA_TO_NATIONAL(MELOETTA),
    UNOVA_TO_NATIONAL(GENESECT),
};
...
u16 NationalToUnovaOrder(u16 nationalNum)
{
    u16 unovaNum;
    ...
    while (unovaNum < (UNOVA_DEX_COUNT - 1) && sUnovaToNationalOrder[unovaNum] != nationalNum)
        unovaNum++;

    if (unovaNum >= UNOVA_DEX_COUNT - 1)
        return 0;
...
u16 SpeciesToUnovaPokedexNum(u16 species)
{
    if (!species)
        return 0;
    return NationalToUnovaOrder(gSpeciesInfo[species].natDexNum);
}

u16 UnovaToNationalOrder(u16 unovaNum)
{
    if (!unovaNum || unovaNum >= UNOVA_DEX_COUNT)
        return 0;

    return sUnovaToNationalOrder[unovaNum - 1];
}
...
u16 SpeciesToPokedexNum(u16 species)
{
    ...
    {
        species = SpeciesToUnovaPokedexNum(species);
        if (species <= UNOVA_DEX_COUNT)
            return species;
        return 0xFFFF;
    }
}

bool32 IsSpeciesInUnovaDex(u16 species)
{
    if (SpeciesToUnovaPokedexNum(species) > UNOVA_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
...
u16 PlayerGenderToFrontTrainerPicId(u8 playerGender)
{
    if (playerGender != MALE)
        ...
        return FacilityClassToPicIndex(FACILITY_CLASS_HILBERT);
}
