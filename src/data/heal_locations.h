...
{
    [HEAL_LOCATION_NUVEMA_TOWN_PLAYERS_HOUSE_2F - 1] = {MAP_GROUP(NUVEMA_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(NUVEMA_TOWN_PLAYERS_HOUSE_2F), 8, 7},
    ...
    [HEAL_LOCATION_NUVEMA_TOWN_PLAYERS_HOUSE - 1] = {MAP_GROUP(NUVEMA_TOWN), MAP_NUM(NUVEMA_TOWN), 14, 16},
