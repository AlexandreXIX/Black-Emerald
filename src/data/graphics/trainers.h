...
const u32 gTrainerPalette_Hilbert[] = INCBIN_U32("graphics/trainers/palettes/hilbert.gbapal.lz");
...
const u32 gTrainerFrontPic_Cheren[] = INCBIN_U32("graphics/trainers/front_pics/cheren.4bpp.lz");
const u32 gTrainerPalette_Cheren[] = INCBIN_U32("graphics/trainers/front_pics/cheren.gbapal.lz");

const u32 gTrainerFrontPic_Bianca[] = INCBIN_U32("graphics/trainers/front_pics/bianca.4bpp.lz");
const u32 gTrainerPalette_Bianca[] = INCBIN_U32("graphics/trainers/front_pics/bianca.gbapal.lz");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_HILBERT, gTrainerFrontPic_Hilbert, gTrainerPalette_Hilbert),
    ...
    TRAINER_SPRITE(TRAINER_PIC_CHEREN, gTrainerFrontPic_Cheren, gTrainerPalette_Cheren),
    TRAINER_SPRITE(TRAINER_PIC_BIANCA, gTrainerFrontPic_Bianca, gTrainerPalette_Bianca),
};
...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_HILBERT, 4, gTrainerBackPic_Hilbert, gTrainerBackPicTable_Hilbert, gTrainerPalette_Hilbert, sBackAnims_Hoenn),
