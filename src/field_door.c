...
static const u8 sDoorAnimTiles_Nuvema[] = INCBIN_U8("graphics/door_anims/nuvema.4bpp");
...
static const u8 sDoorAnimPalettes_Nuvema[] = {10, 10, 6, 6, 6, 6, 6, 6};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Petalburg_Door_Nuvema,                    DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_Nuvema, sDoorAnimPalettes_Nuvema},
