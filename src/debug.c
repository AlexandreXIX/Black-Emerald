...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_POKENAV:
            result = FlagGet(FLAG_SYS_XTRANS_GET);
            break;
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS:
            result = FlagGet(FLAG_VISITED_NUVEMA_TOWN) &&
...
static void DebugAction_FlagsVars_SwitchPokeNav(u8 taskId)
{
    if (FlagGet(FLAG_SYS_XTRANS_GET))
        PlaySE(SE_PC_OFF);
    else
        PlaySE(SE_PC_LOGIN);
    FlagToggle(FLAG_SYS_XTRANS_GET);
}
...
static void DebugAction_FlagsVars_ToggleFlyFlags(u8 taskId)
{
    ...
    {
        PlaySE(SE_PC_OFF);
        FlagClear(FLAG_VISITED_NUVEMA_TOWN);
    ...
    {
        PlaySE(SE_PC_LOGIN);
        FlagSet(FLAG_VISITED_NUVEMA_TOWN);
