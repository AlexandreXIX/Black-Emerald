...
const u8 gText_ExpandedPlaceholder_Hilbert[] = _("HILBERT");
...
const u8 gText_DexUnovaTitle[] = _("UNOVA DEX");
...
const u8 gText_DexUnovaDescription[] = _("UNOVA region's POKéDEX");
...
const u8 gText_BirchInTrouble[] = _("PROF. JUNIPER sent a gift!\nChoose a starter POKéMON!");
...
const u8 gText_Nuvema[] = _("NUVEMA"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_CheckMapOfUnova[] = _("Check the map of the UNOVA region.");
...
const u8 gText_MatchCallHilbert_Strategy[] = _("Battle with knowledge!");
const u8 gText_MatchCallHilbert_Pokemon[] = _("I will use various POKéMON.");
const u8 gText_MatchCallHilbert_Intro1[] = _("I'll be a better POKéMON");
const u8 gText_MatchCallHilbert_Intro2[] = _("prof than my father is!");
...
const u8 gJPText_NewTrainerHasComeToUnova[] = _("あらたな　トレーナーが\nホウエンに　やってきた！");
...
const u8 gText_DexUnova[] = _("UNOVA");
...
const u8 gText_MayHilbertMatchCallDesc[] = _("RAD NEIGHBOR");
