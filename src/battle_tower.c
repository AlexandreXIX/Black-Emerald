...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_HILBERT_1, FACILITY_CLASS_HILBERT},
    {RS_FACILITY_CLASS_HILBERT_2, FACILITY_CLASS_HILBERT_2},
    {RS_FACILITY_CLASS_HILBERT_3, FACILITY_CLASS_HILBERT_3},
