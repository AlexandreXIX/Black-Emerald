...
// MAYBE DEPRACATED
// NEW LOCATION NECESSART, find static const u8 sText_PkmnSurroundedWithVeilOfWater[] = _("{B_ATK_NAME_WITH_PREFIX} surrounded itself\nwith a veil of water!"); static const u8 sText_PkmnLevitatedOnElectromagnetism
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [BATTLESTRINGS_TABLE_START] = sText_BiancaFirstBattle,
    [BATTLESTRINGS_TABLE_START] = sText_CherenFirstBattle,
};
