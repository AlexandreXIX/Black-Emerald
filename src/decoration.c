...
static const u16 sHilbertPalette[] = INCBIN_U16("graphics/decorations/hilbert.gbapal");
...
static const struct SpritePalette sSpritePal_PuttingAwayCursorHilbert =
{
    .data = sHilbertPalette,
...
static void SetUpPlacingDecorationPlayerAvatar(u8 taskId, struct PlaceDecorationGraphicsDataBuffer *data)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        sDecor_CameraSpriteObjectIdx2 = CreateObjectGraphicsSprite(OBJ_EVENT_GFX_HILBERT_DECORATING, SpriteCallbackDummy, x, 72, 0);
    else
...
static void SetUpPuttingAwayDecorationPlayerAvatar(void)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        sDecor_CameraSpriteObjectIdx2 = CreateObjectGraphicsSprite(OBJ_EVENT_GFX_HILBERT_DECORATING, SpriteCallbackDummy, 136, 72, 0);
    else
...
{
    if (gSaveBlock2Ptr->playerGender == MALE)
        LoadSpritePalette(&sSpritePal_PuttingAwayCursorHilbert);
    else
