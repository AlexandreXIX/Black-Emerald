...
// Added for xtransceiver call, not sure if necessary
#define SPRITE_SIZE_120x80   ((ST_OAM_SIZE_3 << 2) | (ST_OAM_V_RECTANGLE))
#define SPRITE_SIZE_60x80   ((ST_OAM_SIZE_3 << 2) | (ST_OAM_V_RECTANGLE))
