...
#define B_TRAINER_CLASS_POKE_BALLS      TRUE // In Gen7+, trainers will use certain types of Poké Balls depending on their trainer class.
...
#define B_ENEMY_THROW_BALLS          TRUE  // In GEN_6+, enemy Trainers throw Poké Balls into battle instead of them just appearing on the ground and opening.
#define B_ENEMY_THROW_BALLS_SOUND    TRUE  // In GEN_5+, enemy Trainer's Poké Balls make a sound when thrown to send out a Pokémon. This can only be used when B_ENEMY_THROW_BALLS is set to GEN_6 or later.
#define B_PLAYER_THROW_BALLS_SOUND   TRUE  // In GEN_5+, the player's Poké Balls make a sound when thrown to send out a Pokémon.
