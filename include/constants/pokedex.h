...
enum {
    ...
    UNOVA_DEX_TIMBURR,
    UNOVA_DEX_GURDURR,
    UNOVA_DEX_CONKELDURR,
    UNOVA_DEX_TYMPOLE,
    UNOVA_DEX_PALPITOAD,
    UNOVA_DEX_SEISMITOAD,
    UNOVA_DEX_THROH,
    UNOVA_DEX_SAWK,
    UNOVA_DEX_SEWADDLE,
    UNOVA_DEX_SWADLOON,
    UNOVA_DEX_LEAVANNY,
    UNOVA_DEX_VENIPEDE,
    UNOVA_DEX_WHIRLIPEDE,
    UNOVA_DEX_SCOLIPEDE,
    UNOVA_DEX_COTTONEE,
    UNOVA_DEX_WHIMSICOTT,
    UNOVA_DEX_PETILIL,
    UNOVA_DEX_LILLIGANT,
    UNOVA_DEX_BASCULIN,
    UNOVA_DEX_SANDILE,
    UNOVA_DEX_KROKOROK,
    UNOVA_DEX_KROOKODILE,
    UNOVA_DEX_DARUMAKA,
    UNOVA_DEX_DARMANITAN,
    UNOVA_DEX_MARACTUS,
    UNOVA_DEX_DWEBBLE,
    UNOVA_DEX_CRUSTLE,
    UNOVA_DEX_SCRAGGY,
    ...
    UNOVA_DEX_SIGILYPH,
    UNOVA_DEX_YAMASK,
    UNOVA_DEX_COFAGRIGUS,
    UNOVA_DEX_TIRTOUGA,
    UNOVA_DEX_CARRACOSTA,
    UNOVA_DEX_ARCHEN,
    UNOVA_DEX_ARCHEOPS,
    UNOVA_DEX_TRUBBISH,
    UNOVA_DEX_GARBODOR,
    ...
    UNOVA_DEX_SAWSBUCK,
    UNOVA_DEX_EMOLGA,
    UNOVA_DEX_KARRABLAST,
    UNOVA_DEX_ESCAVALIER,
    UNOVA_DEX_FOONGUS,
    UNOVA_DEX_AMOONGUSS,
    UNOVA_DEX_FRILLISH,
    UNOVA_DEX_JELLICENT,
    UNOVA_DEX_ALOMOMOLA,
    UNOVA_DEX_JOLTIK,
    UNOVA_DEX_GALVANTULA,
    UNOVA_DEX_FERROSEED,
    UNOVA_DEX_FERROTHORN,
    UNOVA_DEX_KLINK,
    UNOVA_DEX_KLANG,
    UNOVA_DEX_KLINKLANG,
    UNOVA_DEX_TYNAMO,
    UNOVA_DEX_EELEKTRIK,
    UNOVA_DEX_EELEKTROSS,
    UNOVA_DEX_ELGYEM,
    UNOVA_DEX_BEHEEYEM,
    UNOVA_DEX_LITWICK,
    UNOVA_DEX_LAMPENT,
    UNOVA_DEX_CHANDELURE,
    UNOVA_DEX_AXEW,
    UNOVA_DEX_FRAXURE,
    UNOVA_DEX_HAXORUS,
    UNOVA_DEX_CUBCHOO,
...
#define UNOVA_DEX_COUNT (UNOVA_DEX_GENESECT + 1)
